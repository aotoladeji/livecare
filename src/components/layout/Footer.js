...
const LINKS = {
  ...
  Support:  [
    ...
    { label: 'Apply as Caregiver', to: '/caregivers#apply' },
    ...
    <footer className="footer">
      <div className="container">
        <div className="footer__grid">
          ...
          <div className="footer__brand">
            ...
            <div className="footer__socials">
              <SocialIcon href="#" label="Twitter" icon={<TwitterIcon />} />
          ...
          <div className="footer__col">
            ...
            <ul className="footer__contact-list">
              ...
              <li>
                ...
                <a href="mailto:hello@livecare.ng" className="footer__link">hello@livecare.ng</a>
              </li>
              <li>
                <span className="footer__contact-icon">📞</span>
        ...
        <div className="footer__bottom">
          <p>© {new Date().getFullYear()} LiveCare. All rights reserved.</p>
...
function SocialIcon({ href, label, icon }) {
  return (
    <a href={href} aria-label={label} className="footer__social-btn" target="_blank" rel="noopener noreferrer">
      {icon}
    </a>
  );
}
